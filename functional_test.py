...
# @Last Modified time: 2017-08-14 09:22:24
...
class NewVisitorTestCase(unittest.TestCase):
    ...
    def _check_for_row_in_list_table(self, row_text):
        ...
        self.assertIn(row_text, [row.text for row in rows], "[{}] didn't appear in table".format(row_text))
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        ...
        self.assertTrue(self._check_for_row_in_list_table('1: Buy peacock feathers'))
        ...
        inputbox.send_keys(Keys.ENTER)
        self.assertTrue(self._check_for_row_in_list_table('1: Buy peacock feathers'))
        self.assertTrue(self._check_for_row_in_list_table('2: Use peacock feathers to make a fly'))
